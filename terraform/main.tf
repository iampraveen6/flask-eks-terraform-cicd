...
output "configure_kubectl" {
  value = "aws eks update-kubeconfig --region us-west-2 --name ${aws_eks_cluster.main.name}"
}

output "ecr_login" {
  value = "aws ecr get-login-password --region us-west-2 | docker login --username AWS --password-stdin ${aws_ecr_repository.app.repository_url}"
}
